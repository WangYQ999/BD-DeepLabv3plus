...
from datasets import VOCSegmentation, Cityscapes, VOCBridge
...
def get_argparser():
    ...
    # Datset Options
    parser.add_argument(
        "--data_root", type=str, default="./datasets", help="path to Dataset"
    )
    parser.add_argument(
        "--dataset",
        type=str,
        default="voc_bridge",
        choices=["voc", "cityscapes", "voc_bridge"],
    ...
    parser.add_argument(
        "--total_itrs", type=int, default=50e3, help="epoch number (default: 30k及30e3)"
    )
    parser.add_argument(
    ...
    parser.add_argument("--crop_size", type=int, default=1024)  # 513
...
def main():
    ...
    if opts.dataset.lower() == "voc":
        ...
        opts.num_classes = 19
    elif opts.dataset.lower() == "voc_bridge":
        opts.num_classes = 5
    ...
    with open(f"./txt/new.txt", "a") as file:
        interval_loss = 0
        while True:  # cur_itrs < opts.total_itrs:
            ...
            for images, labels in train_loader:
                ...
                if (cur_itrs) % 10 == 0:
                    ...
                    log_str = "Epoch %d, Itrs %d/%d, Loss=%f\n" % (
                        cur_epochs,
                        cur_itrs,
                        opts.total_itrs,
                        interval_loss,
                ...
                if (cur_itrs) % opts.val_interval == 0:
                    ...
                    if vis is not None:  # visualize validation score and samples
                        ...
                        vis.vis_scalar(
                            "[Val] Mean IoU", cur_itrs, val_score["Mean IoU"]
                        )
